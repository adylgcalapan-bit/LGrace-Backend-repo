    ...
    <div class="wrapper">
        ...
        <main class="main-content">
            ...
            <section class="card p-4 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <p class="mb-2"><strong>Name:</strong> John Dela Cruz</p>
                        <p class="mb-2"><strong>Email:</strong> admin@cpvs.com</p>
                        <p class="mb-2"><strong>Contact:</strong> 09123456789</p>
                    </div>
                    <div class="col-md-6">
                        <p class="mb-2"><strong>Role:</strong> Administrator</p>
                        <p class="mb-2"><strong>Account Status:</strong> Active</p>
                        <p class="mb-2"><strong>Last Login:</strong> Jul 30, 2026</p>
                    </div>
                </div>
            </section>
