...
<body>
        ...
        <main class="main-content">
            ...
            <section class="card border-0 shadow-sm">
                <div class="card-header bg-white">
                    <h4 class="mb-0">Announcement List</h4>
                </div>
                        ...
                        <tbody id="announcementTableBody">
                            ...
                            <?php if (!empty($announcements)): ?>
                                ...
                                <?php foreach ($announcements as $announcement): ?>
                                    ...
                                    <tr
                                        data-id="<?= (int) $announcement['announcement_id'] ?>"
                                        data-title="<?= esc($announcement['title']) ?>"
                                        data-content="<?= esc($announcement['content']) ?>"
                                        data-category="<?= esc($announcement['category'] ?? 'General') ?>"
                                        data-publish-date="<?= esc($announcement['publish_date'] ?? '') ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Announcement</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form id="addAnnouncementForm"
                    action="<?= site_url('admin/announcements/create') ?>"
    ...
    <div class="modal fade" id="viewAnnouncementModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">View Announcement</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title">Delete Announcement</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body text-center"><i class="bi bi-exclamation-triangle-fill text-danger" style="font-size:60px;"></i>
